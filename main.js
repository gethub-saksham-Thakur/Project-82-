...
/* concatente the first name add the
 last name to print the full name
 of the person on the console.

 Type the line : "fist_name.conson
 (last_name"
 */
...
/* 
Create a variable named sub and 
store the sudtraction value of a 
and b in that variable.

Type: var sub = a - b 

Then, print the variabl to display the subtraction value
